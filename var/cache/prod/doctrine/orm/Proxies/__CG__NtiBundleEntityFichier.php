 ...
 */
class Fichier extends \NtiBundle\Entity\Fichier implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'NtiBundle\\Entity\\Fichier' . "\0" . 'chemin', '' . "\0" . 'NtiBundle\\Entity\\Fichier' . "\0" . 'idFichier', '' . "\0" . 'NtiBundle\\Entity\\Fichier' . "\0" . 'idUser', '' . "\0" . 'NtiBundle\\Entity\\Fichier' . "\0" . 'idCours'];
        }
    ...
    public function getIdFichier()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getIdFichier();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIdFichier', []);

        return parent::getIdFichier();
    }
