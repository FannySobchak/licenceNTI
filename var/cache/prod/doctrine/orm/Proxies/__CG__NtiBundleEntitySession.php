 ...
 */
class Session extends \NtiBundle\Entity\Session implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'NtiBundle\\Entity\\Session' . "\0" . 'libelle', '' . "\0" . 'NtiBundle\\Entity\\Session' . "\0" . 'dateInscription', '' . "\0" . 'NtiBundle\\Entity\\Session' . "\0" . 'idSession'];
        }
    ...
    public function getIdSession()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getIdSession();
        }
