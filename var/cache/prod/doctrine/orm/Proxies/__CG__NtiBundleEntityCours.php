 ...
 */
class Cours extends \NtiBundle\Entity\Cours implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'NtiBundle\\Entity\\Cours' . "\0" . 'libelle', '' . "\0" . 'NtiBundle\\Entity\\Cours' . "\0" . 'idCours', '' . "\0" . 'NtiBundle\\Entity\\Cours' . "\0" . 'idUser'];
        }
