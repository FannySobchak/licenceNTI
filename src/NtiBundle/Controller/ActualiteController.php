...
use NtiBundle\Entity\Actualite;
use NtiBundle\Form\ActualiteType;
...
class ActualiteController extends Controller
{
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('NtiBundle\Form\ActualiteType', $actualite);
    ...
    {
        $deleteForm = $this->createDeleteForm($actualite);
        $editForm = $this->createForm('NtiBundle\Form\ActualiteType', $actualite);
