...
use NtiBundle\Entity\Session;
use NtiBundle\Form\SessionType;
...
class SessionController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $sessions = $em->getRepository('NtiBundle:Session')->findAll();
    ...
    {
        $session = new Session();
        $form = $this->createForm('NtiBundle\Form\SessionType', $session);
    ...
    {
        $deleteForm = $this->createDeleteForm($session);
        $editForm = $this->createForm('NtiBundle\Form\SessionType', $session);
