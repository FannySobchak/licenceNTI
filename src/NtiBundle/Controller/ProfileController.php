...
use NtiBundle\Entity\Profile;
use NtiBundle\Form\ProfileType;
...
class ProfileController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $profiles = $em->getRepository('NtiBundle:Profile')->findAll();
    ...
    {
        $profile = new Profile();
        $form = $this->createForm('NtiBundle\Form\ProfileType', $profile);
    ...
    {
        $deleteForm = $this->createDeleteForm($profile);
        $editForm = $this->createForm('NtiBundle\Form\ProfileType', $profile);
